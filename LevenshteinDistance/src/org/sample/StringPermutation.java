...
public class StringPermutation {/*
    ...
    public static void main(String args[]) {
        ...
        System.out.println(sp.permute("AABC".toCharArray()));
    }
*/
	

	public void permutation(char[] str, int[] count, int level, char[] result) {
		...
		for(int i=0; i < str.length; i++) {
			...
			count[i]--;
			result[level] = str[i];
			permutation(str, count, level + 1, result);
			count[i]++;
		}
	...
	public static void main (String[] args) {
		...
		obj.permutation(str, count, 0, result);
	}

	private void printResult(char[] charArray) {
